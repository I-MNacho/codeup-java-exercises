...
//BONUS: identify and add another abstract method to the Media class and extend the Media class in additional sub-types (edited)
...
package AbstractClassAndInterface;
    ...
    public void canCheckout(){
        System.out.println("Here you go! Please return in 1 week.");
    }

    abstract void paper();

    abstract void ewPaper();
}
